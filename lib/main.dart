...
void main() async{
  ...
  runApp(MyApp(authRepositoryImp: authRepo,conversationsRepository: conversationsRepository,messageRepository: messageRepository,));
}
...
class MyApp extends StatelessWidget {
  ...
  const MyApp({super.key,required this.authRepositoryImp,required this.conversationsRepository,required this.messageRepository});
